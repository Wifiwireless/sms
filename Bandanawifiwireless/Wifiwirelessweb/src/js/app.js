				...
				[
						...
						function($scope, $window, $rootScope, $location,
							...
							$scope.processForm = function() {
								debugger;
								// $scope.isEmclientName =
								// $scope.formData.clientName.$error.required;
								// $scope.isInvalidEmail =
								// $scope.form.uEmail.$error.email;
								$scope.span1 = '';
								$scope.span2 = '';
								$scope.span3 = '';
								$scope.span4 = '';
								...
								if (!$scope.isformvalid) {
									$scope.span8 = 'Please provide valid details';
									return;
								}
								...
								if ($scope.formData.Username == '') {
									...
									$scope.span1 = 'Please enter Username';
									$location.hash('default-step-0');
								...
								if ($scope.formData.password == '') {
									...
									$scope.span5 = 'Please enter password';
									$location.hash('default-step-0');
								...
								if ($scope.formData.pattern == '') {

									$scope.span2 = 'Please enter Number Pattern';
								...
								var response = $http.post('70.182.179.17:8080/wifiwireless/get/number',
										$scope.formData);
